...
import net.testaholic_acme_site.domain.User;
import net.testaholic_acme_site.repository.AuthorityRepository;
import net.testaholic_acme_site.repository.UserRepository;
import net.testaholic_acme_site.security.AuthoritiesConstants;
import net.testaholic_acme_site.service.MailService;
import net.testaholic_acme_site.service.UserService;
import net.testaholic_acme_site.web.rest.dto.ManagedUserDTO;
import net.testaholic_acme_site.web.rest.dto.UserDTO;
